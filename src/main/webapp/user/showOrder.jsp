...
<div id="show">
	<div id="info">
		...
		<div style="text-align:center;">
			...
			<input type="button" onclick="window.location.href='receiveOrder?orderid=${sessionScope.get("b").orderid}'"
				   value="确认收货"
					...
					<form action="../updateOrder?orderid=${sessionScope.get("b").orderid}" method="post">
						<div class="modal-body">
							...
							<input type="text" name="orderEntity.itemamount" class="form-control"
								   value="${sessionScope.get("b").amount}">
							<p>货物重量</p>
							<input type="text" name="orderEntity.itemsize" class="form-control"
								   value="${sessionScope.get("b").itemsize}">
							<p>期望时间</p>
